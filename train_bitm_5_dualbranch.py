...
from models.bitm import BiTMDualBranchBERTStrictAR
...
bitm_model = BiTMDualBranchBERTStrictAR(bert_name=bert_name,
                                        vqvae=net,
                                        ...
                                        finetune_text_branch=args.finetune_text_branch,
                                        dualbranch_cross_layers=args.dualbranch_cross_layers,
                                        dualbranch_motion_layers=args.dualbranch_motion_layers)
...
model_unwrapped = get_model(bitm_model)
trainable_params = sum(param.numel() for param in model_unwrapped.parameters() if param.requires_grad)
text_trainable_params = sum(param.numel() for param in model_unwrapped.text_bert.parameters() if param.requires_grad)
logger.info(
    f'Dual-branch BiTM: {trainable_params:,} params trainable; '
    f'text_branch_trainable={text_trainable_params:,}; '
    f'cross_layers={sorted(model_unwrapped.cross_layer_ids)}; '
    f'motion_layers={model_unwrapped.dualbranch_motion_layers}.'
)
logger.info(
